...
const Ants = () => {
  return (
    <section className="bg-cover bg-center text-white" style={{ backgroundImage: "url('assets/bed_bug.jpg')" }}>
      <div className="bg-black bg-opacity-60 py-16 px-6 md:px-12 lg:px-24">
        <div className="text-center">
          <h2 className="text-lime-400 text-lg font-semibold uppercase tracking-wide">BED BUG EXTERMINATOR</h2>
          <h1 className="text-4xl sm:text-md font-extrabold mt-2">
            Bed Bug Exterminator | Fast & Reliable Bed Bug Control 
